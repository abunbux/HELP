...
# Time-stamp: <Последнее обновление -- Tuesday June 28 18:56:43 EEST 2022>
...
*** Правила написания кода
    ...
    - [[file:python/coding_style_in_Python/README.org][Общепринятый стиль кода на языке Python]]
...
*** Примеры
    ...
    - [[file:python/examples/exists/README.org][Проверка наличия объекта по указанному пути]].
