...
# Time-stamp: <Последнее обновление -- Sunday May 29 12:57:21 EEST 2022>
...
*** Ведение логов в Python
    ...
    [[file:python/module_logging.org][модуль logging]]
    [[file:python/module_loguru.org][модуль loguru]]
