...
# Time-stamp: <Последнее обновление -- Wednesday June 8 21:24:19 EEST 2022>
...
** DONE Переписать код с использованием argparse.
   CLOSED: [2022-06-08 Wed 21:22] DEADLINE: <2022-06-12 Sun>

   [[file:watchdog_of_doc.py][watchdog_of_doc.py]]
